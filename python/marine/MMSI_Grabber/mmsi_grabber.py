...
#mmsi_grabber.py
#2019-06-28
#program loads marine traffic webpage, enters mmsi number and scrapes the page, then uses vessel information to construct a gpx file for import to OpenCPN
#
# Author: Dave
...
try:
    ...
    for symbol in '°':
        Speed_Course = Speed_Course.replace(symbol, 'DEG')
    print(Speed_Course)
    ...
    for filename in glob.iglob(os.path.join('C:\\Users\\winedoze\\Desktop\\Marine_Traffic_Grabber', '*.txt')):
